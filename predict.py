...
def main(args):
    ...
    for batch_idx, data in enumerate(tqdm(dataloader)):
        ...
        captions = generate(model.half(), clip_embeds, tokenizer, args)
    ...
    if args.finetune_gpt2:
        save_path = join(args.output_path, 'caption_generate_finetune1.txt')
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', default='datasets/test1')
    parser.add_argument('--model_path', default='output/mlp_finetune/checkpoint-200.pt')
    parser.add_argument('--gpt2_model_path', default="pretrain_models/gpt2_2")
    ...
    parser.add_argument('--topk', default=0, type=int, required=False)
    parser.add_argument('--topp', default=0.8, type=float, required=False, help='')
    parser.add_argument('--num_generate', default=2, type=int, required=False)
    parser.add_argument('--finetune_gpt2', help='finetune gpt2', action='store_true', default=True)
