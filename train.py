...
import os
import argparse
from dataset import ThinGPTDataset
from models.model import ThinGPTModel
import time
...
def set_args():
    ...
    parser.add_argument('--data_path', default='datasets/ThinGPT.pkl')
    parser.add_argument('--gpt2_path', default='pretrain_models/gpt2_2')
...
def main(args):
    ...
    if args.do_train:
        dataset = ThinGPTDataset(args.data_path, args.prefix_len, tokenizer, args.max_len, 'train', args.normalize_prefix)
