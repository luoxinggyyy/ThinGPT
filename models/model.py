...
class ThinGPTModel(nn.Module):
    ...
    def parameters(self, recurse: bool = True):
        if self.finetune_gpt2:
            return super(ThinGPTModel, self).parameters()
        else:
...
if __name__ == '__main__':
    config = AutoConfig.from_pretrained('E:/Code/ClipCap-Chinese-master/ClipCap-Chinese-master/pretrain_models/pt2_1/config.json')
